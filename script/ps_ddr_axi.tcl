...
################################################################
# This is a generated script based on design: ps_ddr_axi_interconnect
#
...
# source ps_ddr_axi_interconnect_script.tcl
...
set design_name ps_ddr_axi_interconnect
...
proc create_root_design { parentCell } {
  ...
  set M00_ACLK [ create_bd_port -dir I -type clk -freq_hz 300000000 M00_ACLK ]
  set_property -dict [ list \
  ...
  connect_bd_net -net ACLK_1 [get_bd_ports ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK]
  ...
  connect_bd_net -net M00_ACLK_1 [get_bd_ports M00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK]
  connect_bd_net -net M00_ARESETN_1 [get_bd_ports M00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN]

  # Create address segments
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S04_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
